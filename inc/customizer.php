...
function online_food_delivery_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('online_food_delivery_demo_link',array(
		'type'=> 'hidden',
		'description' => "<h3>". esc_html__('Theme Demo','online-food-delivery') ."</h3><p>". esc_html__('Our premium version of Online Food Delivery has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.','online-food-delivery') ."</p> <a target='_blank' href='". esc_url('https://preview.themescaliber.com/online-food-delivery-pro/') ." '>". esc_html__('View Demo','online-food-delivery') ."</a>",
	...
	$wp_customize->add_control('online_food_delivery_doc_link',array(
		'type'=> 'hidden',
		'description' => "<h3>". esc_html__('Theme Documentation','online-food-delivery') ."</h3><p>". esc_html__('We have well prepared documentation that provides the general guidelines and suggestions needed for this theme.','online-food-delivery') ."</p> <a target='_blank' href='". esc_url('https://preview.themescaliber.com/doc/free-online-food-delivery/') ." '>". esc_html__('View Documentation','online-food-delivery') ."</a>",
		'section'=> 'online_food_delivery_about_theme'
	));
	...
	$wp_customize->add_control('online_food_delivery_forum_link',array(
		'type'=> 'hidden',
		'description' => "<h3>". esc_html__('Theme Support','online-food-delivery') ."</h3><p>". esc_html__('Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.','online-food-delivery') ."</p><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/online-food-delivery/') ." '>". esc_html__('Support Forum','online-food-delivery') ."</a>",
		'section'=> 'online_food_delivery_about_theme'
	));

	$wp_customize->add_setting('online_food_delivery_review_link',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_review_link',array(
		'type'=> 'hidden',
		'description' => "<h3>". esc_html__('Theme Review','online-food-delivery') ."</h3><p>". esc_html__('If you enjoy using our theme, we’d love to hear your feedback. please leave us a review.','online-food-delivery') ."</p><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/online-food-delivery/reviews/#new-post') ." '>". esc_html__('Rate & Review','online-food-delivery') ."</a>",
		'section'=> 'online_food_delivery_about_theme'
	));			
	...
	$wp_customize->add_setting('online_food_delivery_body_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
    ));
    $wp_customize->add_control('online_food_delivery_body_font_weight',array(
        'type' => 'select',
        'label' => __('Body Font Weight','online-food-delivery'),
        'section' => 'online_food_delivery_typography',
        'choices' => array(
	...
	$wp_customize->add_setting('online_food_delivery_paragraph_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_paragraph_font_weight',array(
		'type' => 'select',
		'label' => __('Paragraph Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_atag_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_atag_font_weight',array(
		'type' => 'select',
		'label' => __('"a" Tag Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_li_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_li_font_weight',array(
		'type' => 'select',
		'label' => __('"li" Tag Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_h1_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_h1_font_weight',array(
		'type' => 'select',
		'label' => __('h1 Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_h2_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_h2_font_weight',array(
		'type' => 'select',
		'label' => __('h2 Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_h3_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_h3_font_weight',array(
		'type' => 'select',
		'label' => __('h3 Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_h4_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_h4_font_weight',array(
		'type' => 'select',
		'label' => __('h4 Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_h5_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_h5_font_weight',array(
		'type' => 'select',
		'label' => __('h5 Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_h6_font_weight',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_h6_font_weight',array(
		'type' => 'select',
		'label' => __('h6 Font Weight','online-food-delivery'),
		'section' => 'online_food_delivery_typography',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
			'200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting( 'online_food_delivery_sticky_sidebar', array(
		'default'           => false,
		'sanitize_callback' => 'online_food_delivery_sanitize_checkbox',
	) );
	
	$wp_customize->add_control( 'online_food_delivery_sticky_sidebar', array(
		'type'     => 'checkbox',
		'label'    => __( 'Enable Sticky Sidebar', 'online-food-delivery' ),
		'section'  => 'online_food_delivery_left_right',
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'online_food_delivery_preloader_bg_color', array(
 	...
 	$wp_customize->add_setting('online_food_delivery_preloader_background_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'online_food_delivery_preloader_background_img',array(
        'label' => __('Preloader Background Image','online-food-delivery'),
        'section' => 'online_food_delivery_left_right'
	)));		
	...
	$wp_customize->add_setting( 'online_food_delivery_menu_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('online_food_delivery_menu_settings_premium_features', array(
    	'type'=> 'hidden',
        'description' => "<h3>". esc_html__('More Features in the Premium Version!','online-food-delivery') ."</h3>
        	<ul>
        		<li>". esc_html__('Menu Background Colors','online-food-delivery') ."</li>
        		<li>". esc_html__('Menu Item Fonts','online-food-delivery') ."</li>
        		<li>". esc_html__('Responsive Menu Colors','online-food-delivery') ."</li>
        		<li>". esc_html__('Header Search Icons Colors','online-food-delivery') ."</li>
        		<li>". esc_html__('... and Other Premium Features','online-food-delivery') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/food-ordering-wordpress-theme') ." '>". esc_html__('Upgrade Now','online-food-delivery') ."</a>",
	...
	$wp_customize->add_setting('online_food_delivery_menu_padding', array(
		'default'           => '',
		'sanitize_callback' => 'absint',
	));

	$wp_customize->add_control('online_food_delivery_menu_padding', array(
		'label'       => __('Menu Font Padding', 'online-food-delivery'),
		'section'     => 'online_food_delivery_header',
		'type'        => 'number', 
		'input_attrs' => array(
			'step' => 1,
	...
	$wp_customize->add_setting('online_food_delivery_menus_item_style',array(
        'default' => '',
        'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_menus_item_style',array(
        'type' => 'select',
		'label' => __('Menu Item Hover Style','online-food-delivery'),
		'section' => 'online_food_delivery_header',
		'choices' => array(
            'None' => __('None','online-food-delivery'),
            'Zoom In' => __('Zoom In','online-food-delivery'),
        ),
	));
	...
	$wp_customize->add_setting('online_food_delivery_facebook_icon',array(
		'default'	=> 'fab fa-facebook-f',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_facebook_icon',array(
		'label'	=> __('Add Facebook Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons',
		'setting'	=> 'online_food_delivery_facebook_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('online_food_delivery_twitter_icon',array(
		'default'	=> 'fab fa-twitter',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_twitter_icon',array(
		'label'	=> __('Add Twitter Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons',
		'setting'	=> 'online_food_delivery_twitter_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('online_food_delivery_linkedin_icon',array(
		'default'	=> 'fab fa-linkedin-in',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_linkedin_icon',array(
		'label'	=> __('Add Linkedin Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons',
		'setting'	=> 'online_food_delivery_linkedin_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('online_food_delivery_instagram_icon',array(
		'default'	=> 'fab fa-instagram',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_instagram_icon',array(
		'label'	=> __('Add Instagram Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons',
		'setting'	=> 'online_food_delivery_instagram_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('online_food_delivery_whatsapp_icon',array(
		'default'	=> 'fab fa-whatsapp',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_whatsapp_icon',array(
		'label'	=> __('Add Whatsapp Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons',
		'setting'	=> 'online_food_delivery_whatsapp_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('online_food_delivery_pintrest_icon',array(
		'default'	=> 'fab fa-pinterest-p',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_pintrest_icon',array(
		'label'	=> __('Add pintrest Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons',
		'setting'	=> 'online_food_delivery_pintrest_icon',
		'type'		=> 'icon'
	)));
	$wp_customize->add_setting( 'online_food_delivery_header_icon_font_size',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_float'
	));
	$wp_customize->add_control('online_food_delivery_header_icon_font_size',array(
		'label' => esc_html__( 'Icon Font Size','online-food-delivery' ),
		'type' => 'number',
		'section' => 'online_food_delivery_social_icons',
		'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting( 'online_food_delivery_header_icon_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'online_food_delivery_header_icon_color', array(
		'label' => __('Icon Color', 'online-food-delivery'),
		'section' => 'online_food_delivery_social_icons',
		'settings' => 'online_food_delivery_header_icon_color',
	)));
	...
	$wp_customize->add_setting('online_food_delivery_slider_prev_icon',array(
		'default'	=> 'fas fa-long-arrow-alt-left',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_slider_prev_icon',array(
		'label'	=>__('Add Slider Prev Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_slidersettings',
		'setting'	=> 'online_food_delivery_slider_prev_icon',
		'type'		=> 'icon',
	)));

	$wp_customize->add_setting('online_food_delivery_slider_next_icon',array(
		'default'	=> 'fas fa-long-arrow-alt-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_slider_next_icon',array(
		'label'	=> __('Add Slider Next Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_slidersettings',
		'setting'	=> 'online_food_delivery_slider_next_icon',
		'type'		=> 'icon',
	)));

	//Show / Hide slider Arrow
	$wp_customize->add_setting('online_food_delivery_slider_arrow',array(
		'default' => 'true',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	 ));
	 
	 $wp_customize->add_control('online_food_delivery_slider_arrow',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide slider Arrow','online-food-delivery'),
		'section' => 'online_food_delivery_slidersettings',
	 ));
	...
	$wp_customize->add_setting('online_food_delivery_slider_opacity_color',array(
		'default'              => 0.9,
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	  ));
	  $wp_customize->add_control( 'online_food_delivery_slider_opacity_color', array(
		  'label'       => esc_html__( 'Slider Image Opacity','online-food-delivery' ),
		  'section'     => 'online_food_delivery_slidersettings',
		  'type'        => 'select',
		  'settings'    => 'online_food_delivery_slider_opacity_color',
		  'choices' => array(
			'0' =>  esc_attr('0','online-food-delivery'),
			'0.1' =>  esc_attr('0.1','online-food-delivery'),
			'0.2' =>  esc_attr('0.2','online-food-delivery'),
			'0.3' =>  esc_attr('0.3','online-food-delivery'),
			'0.4' =>  esc_attr('0.4','online-food-delivery'),
			'0.5' =>  esc_attr('0.5','online-food-delivery'),
			'0.6' =>  esc_attr('0.6','online-food-delivery'),
			'0.7' =>  esc_attr('0.7','online-food-delivery'),
			'0.8' =>  esc_attr('0.8','online-food-delivery'),
			'0.9' =>  esc_attr('0.9','online-food-delivery')
		  ),
	  ));
	$wp_customize->add_setting('online_food_delivery_slider_image_overlay',array(
        'default' => false,
        'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_slider_image_overlay',array(
     	'type' => 'checkbox',
      	'label' => __('Show / Hide Slider Image Overlay','online-food-delivery'),
      	'section' => 'online_food_delivery_slidersettings',
	));

	$wp_customize->add_setting( 'online_food_delivery_slider_overlay_color', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'online_food_delivery_slider_overlay_color', array(
	    'label' => __('Slider Overlay Color', 'online-food-delivery'),
	    'section' => 'online_food_delivery_slidersettings',
  	)));
	...
	$wp_customize->add_setting( 'online_food_delivery_category_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('online_food_delivery_category_settings_premium_features', array(
    	'type'=> 'hidden',
        'description' => "<h3>". esc_html__('More Features in the Premium Version!','online-food-delivery') ."</h3>
        	<ul>
        		<li>". esc_html__('Content Color Option','online-food-delivery') ."</li>
        		<li>". esc_html__('Content Font Option','online-food-delivery') ."</li>
        		<li>". esc_html__('... and Other Premium Features','online-food-delivery') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/food-ordering-wordpress-theme') ." '>". esc_html__('Upgrade Now','online-food-delivery') ."</a>",
	...
	$wp_customize->add_setting('online_food_delivery_category_hide_show',array(
		'default' => false,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_category_hide_show',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide Category Section','online-food-delivery'),
		'description' => __('Image size (1080px x 600px)','online-food-delivery'),
		'section' => 'online_food_delivery_food_category_section',
	));
    ...
    $wp_customize->add_setting( 'online_food_delivery_post_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('online_food_delivery_post_settings_premium_features', array(
    	'type'=> 'hidden',
        'description' => "<h3>". esc_html__('More Features in the Premium Version!','online-food-delivery') ."</h3>
        	<ul>
        		<li>". esc_html__('Section Heading Options','online-food-delivery') ."</li>
        		<li>". esc_html__('Animated Elements Colors','online-food-delivery') ."</li>
        		<li>". esc_html__('... and Other Premium Features','online-food-delivery') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/food-ordering-wordpress-theme') ." '>". esc_html__('Upgrade Now','online-food-delivery') ."</a>",
	...
	$wp_customize->add_setting('online_food_delivery_blog_post_alignment',array(
        'default' => 'left',
        'sanitize_callback' => 'online_food_delivery_sanitize_choices'
    ));
	$wp_customize->add_control('online_food_delivery_blog_post_alignment', array(
        'type' => 'select',
        'label' => __( 'Blog Post Alignment', 'online-food-delivery' ),
        'section' => 'online_food_delivery_blog_post',
        'choices' => array(
            'left' => __('Left Align','online-food-delivery'),
            'right' => __('Right Align','online-food-delivery'),
            'center' => __('Center Align','online-food-delivery')
        ),
    ));

	$wp_customize->add_setting('online_food_delivery_initial_caps_enable',
	array(
		'default' => false,
		'sanitize_callback' => 'online_food_delivery_sanitize_checkbox',
	)); 
	$wp_customize->add_control( 'online_food_delivery_initial_caps_enable', 
	array(
		'label' => esc_html__('Initial Letter Capital', 'online-food-delivery'),
		'type' => 'checkbox',
		'section' => 'online_food_delivery_blog_post',
	));
    ...
    $wp_customize->add_setting('online_food_delivery_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_blog_post',
		'setting'	=> 'online_food_delivery_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('online_food_delivery_author_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_author_icon',array(
		'label'	=> __('Add Post Author Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_blog_post',
		'setting'	=> 'online_food_delivery_author_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('online_food_delivery_comment_icon',array(
		'default'	=> 'fa fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_comment_icon',array(
		'label'	=> __('Add Post Comment Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_blog_post',
		'setting'	=> 'online_food_delivery_comment_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('online_food_delivery_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_time_icon',array(
		'label'	=> __('Add Post Time Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_blog_post',
		'setting'	=> 'online_food_delivery_time_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('online_food_delivery_show_hide_post_categories',array(
       'default' => true,
       'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
    ));
    $wp_customize->add_control('online_food_delivery_show_hide_post_categories',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable post category','online-food-delivery'),
       'section' => 'online_food_delivery_blog_post'
    ));
	...
	$wp_customize->add_setting('online_food_delivery_blog_post_featured_image_dimension',array(
		'default' => 'default',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_blog_post_featured_image_dimension',array(
		'type' => 'select',
		'label'	=> __('Featured Image Dimension','online-food-delivery'),
		'section'	=> 'online_food_delivery_blog_post',
		'choices' => array(
		'default' => __('Default','online-food-delivery'),
		'custom' => __('Custom Image Size','online-food-delivery'),
	),
	));

	$wp_customize->add_setting('online_food_delivery_blog_post_featured_image_custom_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_blog_post_featured_image_custom_width',array(
		'label'	=> __('Featured Image Custom Width','online-food-delivery'),
		'description'	=> __('Enter a value in pixels. Example:20px','online-food-delivery'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'online-food-delivery' ),),
		'section'=> 'online_food_delivery_blog_post',
		'type'=> 'text',
		'active_callback' => 'online_food_delivery_blog_post_featured_image_dimension'
	));

	$wp_customize->add_setting('online_food_delivery_blog_post_featured_image_custom_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_blog_post_featured_image_custom_height',array(
		'label'	=> __('Featured Image Custom Height','online-food-delivery'),
		'description'	=> __('Enter a value in pixels. Example:20px','online-food-delivery'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'online-food-delivery' ),),
		'section'=> 'online_food_delivery_blog_post',
	...
	// Button Settings
	$wp_customize->add_section( 'online_food_delivery_button_option', array(
		'title' => __('Post Button Settings','online-food-delivery'),
		'panel' => 'online_food_delivery_panel_id',
	));
	...
	$wp_customize->add_control( 'online_food_delivery_post_button_text', array(
		...
		'section'     => 'online_food_delivery_button_option',
		'type'        => 'text',
		'settings'    => 'online_food_delivery_post_button_text'
	) );

	$wp_customize->add_setting( 'online_food_delivery_button_font_size', array(
		'default'           => 15,
		'sanitize_callback' => 'online_food_delivery_sanitize_float',
	) );
	$wp_customize->add_control( 'online_food_delivery_button_font_size', array(
		'label' => __( 'Button Font Size','online-food-delivery' ),
		'section'     => 'online_food_delivery_button_option',
		'type'        => 'number',
		'input_attrs' => array(
			'step' => 1,
	...
	// text trasform
	$wp_customize->add_setting('online_food_delivery_button_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_button_text_transform',array(
		'type' => 'radio',
		'label' => __('Button Text Transform','online-food-delivery'),
		'choices' => array(
			'Uppercase' => __('Uppercase','online-food-delivery'),
			'Capitalize' => __('Capitalize','online-food-delivery'),
			'Lowercase' => __('Lowercase','online-food-delivery'),
		),
		'section'=> 'online_food_delivery_button_option',
	));
	...
	$wp_customize->add_setting('online_food_delivery_btn_font_weight',array(
		'default'=> '',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices',
	));
	$wp_customize->add_control('online_food_delivery_btn_font_weight',array(
		'label'	=> __('Button Font Weight','online-food-delivery'),
		'section'=> 'online_food_delivery_button_option',
		'type' => 'select',
		'choices' => array(
			'100' => __('100','online-food-delivery'),
	...
	$wp_customize->add_setting( 'online_food_delivery_button_letter_spacing',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_float'
	));
	$wp_customize->add_control('online_food_delivery_button_letter_spacing', array(
		'label'  =>  esc_html__('Button Letter Spacing','online-food-delivery'),
		'type'=> 'number',
		'section'  => 'online_food_delivery_button_option',
		'input_attrs' => array(
			'step' => 1,
	...
	// Button Shape
	$wp_customize->add_setting('online_food_delivery_btn_shape',array(
		'default'=> 'Square',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices',
	));
	$wp_customize->add_control('online_food_delivery_btn_shape',array(
		'label'	=> __('Button Shape','online-food-delivery'),
		'section'=> 'online_food_delivery_button_option',
		'type' => 'select',
		'choices' => array(
			'Square' => __('Square','online-food-delivery'),
			'Round' => __('Round','online-food-delivery'),
			'Pill' => __('Pill','online-food-delivery'),
		),
	));	

	// Button Hover Effect
	$wp_customize->add_setting('online_food_delivery_button_hover_effect',array(
		'default' => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_button_hover_effect', array(
		'label' => __( 'Button Hover Effect', 'online-food-delivery' ),
		'section' => 'online_food_delivery_button_option',
		'type' => 'select',
		'choices' => array(
			'pulse'     => __( 'Pulse', 'online-food-delivery' ),
			'rubberBand'=> __( 'RubberBand', 'online-food-delivery' ),
			'swing'     => __( 'Swing', 'online-food-delivery' ),
			'tada'      => __( 'Tada', 'online-food-delivery' ),
			'jello'     => __( 'Jello', 'online-food-delivery' ),
			'disable'   => __( 'Disabled', 'online-food-delivery' )
		),
	));
    ...
    $wp_customize->add_setting('online_food_delivery_single_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_single_postdate_icon',array(
		'label'	=> __('Add Sigle Post Date Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_single_post',
		'setting'	=> 'online_food_delivery_single_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('online_food_delivery_single_postauthor_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_single_postauthor_icon',array(
		'label'	=> __('Add Sigle Post Author Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_single_post',
		'setting'	=> 'online_food_delivery_single_postauthor_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('online_food_delivery_single_postcomment_icon',array(
		'default'	=> 'fa fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_single_postcomment_icon',array(
		'label'	=> __('Add Sigle Post Comment Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_single_post',
		'setting'	=> 'online_food_delivery_single_postcomment_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('online_food_delivery_single_posttime_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_single_posttime_icon',array(
		'label'	=> __('Add Sigle Post Time Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_single_post',
		'setting'	=> 'online_food_delivery_single_posttime_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('online_food_delivery_single_post_featured_image_dimension',array(
		'default' => 'default',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices'
	));
	
	$wp_customize->add_control('online_food_delivery_single_post_featured_image_dimension',array(
		'type' => 'select',
		'label'	=> __('Single Post Image Dimension','online-food-delivery'),
		'section'	=> 'online_food_delivery_single_post',
		'choices' => array(
		'default' => __('Default','online-food-delivery'),
		'custom' => __('Custom Image Size','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_single_post_featured_image_custom_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_single_post_featured_image_custom_width',array(
		'label'	=> __('Custom Width','online-food-delivery'),
		'description'	=> __('Enter a value in pixels. Example:20px','online-food-delivery'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'online-food-delivery' ),),
		'section'=> 'online_food_delivery_single_post',
		'type'=> 'text',
		'active_callback' => 'online_food_delivery_single_post_featured_image_dimension'
	));

	$wp_customize->add_setting('online_food_delivery_single_post_featured_image_custom_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_single_post_featured_image_custom_height',array(
		'label'	=> __('Custom Height','online-food-delivery'),
		'description'	=> __('Enter a value in pixels. Example:20px','online-food-delivery'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'online-food-delivery' ),),
		'section'=> 'online_food_delivery_single_post',
	...
	// related post
	$wp_customize->add_section('online_food_delivery_related_post',array(
		'title'	=> __('Related Post Settings','online-food-delivery'),
		'panel' => 'online_food_delivery_panel_id',
	));	
    ...
    $wp_customize->add_control('online_food_delivery_related_posts',array(
       ...
       'section' => 'online_food_delivery_related_post'
    ));

	$wp_customize->add_setting('online_food_delivery_related_post_image_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_related_post_image_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Related Post Featured Image','online-food-delivery'),
		'section' => 'online_food_delivery_related_post'
	));
	...
	$wp_customize->add_setting('online_food_delivery_related_metafields_date',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_related_metafields_date',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Date','online-food-delivery'),
		'section' => 'online_food_delivery_related_post'
	));

    $wp_customize->add_setting('online_food_delivery_related_metafields_author',array(
       'default' => true,
       'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
    ));
    $wp_customize->add_control('online_food_delivery_related_metafields_author',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Author','online-food-delivery'),
       'section' => 'online_food_delivery_related_post'
    ));

    $wp_customize->add_setting('online_food_delivery_related_metafields_comment',array(
       'default' => true,
       'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
    ));
    $wp_customize->add_control('online_food_delivery_related_metafields_comment',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Comments','online-food-delivery'),
       'section' => 'online_food_delivery_related_post'
    ));

    $wp_customize->add_setting('online_food_delivery_related_metafields_time',array(
       'default' => true,
       'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
    ));
    $wp_customize->add_control('online_food_delivery_related_metafields_time',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Time','online-food-delivery'),
       'section' => 'online_food_delivery_related_post'
    ));

	$wp_customize->add_setting('online_food_delivery_related_post_metabox_seperator',array(
       'default' => '|',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('online_food_delivery_related_post_metabox_seperator',array(
       'type' => 'text',
       'label' => __('Metabox Seperator','online-food-delivery'),
       'description' => __('Ex: "/", "|", "-", ...','online-food-delivery'),
       'section' => 'online_food_delivery_related_post'
    ...
    $wp_customize->add_setting( 'online_food_delivery_related_post_excerpt_number',array(
	    'default' => 20,
	    'sanitize_callback'    => 'absint',
	));

	$wp_customize->add_control('online_food_delivery_related_post_excerpt_number',  array(
	    'label' => esc_html__( 'Related Posts Content Limit','online-food-delivery' ),
	    'section' => 'online_food_delivery_related_post',
	    'type'    => 'number',
	    'settings' => 'online_food_delivery_related_post_excerpt_number',
	    'input_attrs' => array(
	    'min' => 0,
	    'max' => 50,
	    'step' => 1,
	...
	$wp_customize->add_setting( 'online_food_delivery_related_post_excerpt_suffix', array(
		'default'   => __('[...]','online-food-delivery' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'online_food_delivery_related_post_excerpt_suffix', array(
		'label'       => esc_html__( 'Excerpt Suffix','online-food-delivery' ),
		'section'     => 'online_food_delivery_related_post',
		'type'        => 'text',
		'settings' => 'online_food_delivery_related_post_excerpt_suffix'
	) );

	//Grid Post Settings
	$wp_customize->add_section('online_food_delivery_grid_post',array(
		'title'	=> __('Grid Post Settings','online-food-delivery'),
		'panel' => 'online_food_delivery_panel_id',
	));	

	$wp_customize->add_setting('online_food_delivery_grid_columns', array(
		'default'           => '3',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices',
		'transport'         => 'refresh',
	));
	$wp_customize->add_control('online_food_delivery_grid_columns', array(
		'label'    => __('Grid Columns', 'online-food-delivery'),
		'section'  => 'online_food_delivery_grid_post', 
		'type'     => 'select',
		'choices'  => array(
			'3' => __('3 Columns', 'online-food-delivery'),
			'4' => __('4 Columns', 'online-food-delivery'),
		),
	));

	$wp_customize->add_setting('online_food_delivery_grid_post_image_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_image_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Grid Post Featured Image','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post'
	));

	$wp_customize->add_setting('online_food_delivery_grid_post_date_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_date_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Post Date','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post'
	));

	$wp_customize->add_setting('online_food_delivery_grid_post_date_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_grid_post_date_icon',array(
		'label'	=> __('Add Grid Post Date Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_grid_post',
		'setting'	=> 'online_food_delivery_grid_post_date_icon',
		'type'		=> 'icon'
	)));
 
	$wp_customize->add_setting('online_food_delivery_grid_post_author_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_author_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Post Author','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post'
	));

	$wp_customize->add_setting('online_food_delivery_grid_post_author_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_grid_post_author_icon',array(
		'label'	=> __('Add Grid Post Author Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_grid_post',
		'setting'	=> 'online_food_delivery_grid_post_author_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('online_food_delivery_grid_post_comment_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_comment_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Post Comments','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post'
	));

	$wp_customize->add_setting('online_food_delivery_grid_post_comment_icon',array(
		'default'	=> 'fa fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_grid_post_comment_icon',array(
		'label'	=> __('Add Grid Post Comment Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_grid_post',
		'setting'	=> 'online_food_delivery_grid_post_comment_icon',
		'type'		=> 'icon'
	)));
 
	$wp_customize->add_setting('online_food_delivery_grid_post_time_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_time_hide',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Post Time','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post'
	)); 

	$wp_customize->add_setting('online_food_delivery_grid_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_grid_post_time_icon',array(
		'label'	=> __('Add Grid Post Time Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_grid_post',
		'setting'	=> 'online_food_delivery_grid_post_time_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('online_food_delivery_grid_post_metabox_seperator',array(
		'default' => '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_metabox_seperator',array(
		'type' => 'text',
		'label' => __('Metabox Seperator','online-food-delivery'),
		'description' => __('Ex: "/", "|", "-", ...','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post'
	...
	$wp_customize->add_setting('online_food_delivery_grid_post_content',array(
		'default' => 'Excerpt Content',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_grid_post_content',array(
		'type' => 'radio',
		'label' => __('Grid Post Content Type','online-food-delivery'),
		'section' => 'online_food_delivery_grid_post',
		'choices' => array(
			'No Content' => __('No Content','online-food-delivery'),
			'Full Content' => __('Full Content','online-food-delivery'),
	...
	$wp_customize->add_setting( 'online_food_delivery_grid_post_excerpt_length', array(
		'default'              => 20,
		'sanitize_callback'	=> 'absint'
	) );
	$wp_customize->add_control( 'online_food_delivery_grid_post_excerpt_length', array(
		'label' => esc_html__( 'Grid Post Excerpt Length','online-food-delivery' ),
		'section'  => 'online_food_delivery_grid_post',
		'type'  => 'number',
		'settings' => 'online_food_delivery_grid_post_excerpt_length',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
			'max'              => 50,
		),
		'active_callback' => 'online_food_delivery_grid_excerpt_enabled'
	) );

	$wp_customize->add_setting( 'online_food_delivery_grid_post_button_excerpt_suffix', array(
		'default'   => __('[...]','online-food-delivery' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'online_food_delivery_grid_post_button_excerpt_suffix', array(
		'label'       => esc_html__( 'Grid Post Excerpt Suffix','online-food-delivery' ),
		'section'     => 'online_food_delivery_grid_post',
		'type'        => 'text',
		'settings' => 'online_food_delivery_grid_post_button_excerpt_suffix',
		'active_callback' => 'online_food_delivery_grid_excerpt_enabled'
	) );

	$wp_customize->add_setting( 'online_food_delivery_grid_post_blocks', array(
        'default'			=> 'Without box',
        'sanitize_callback'	=> 'online_food_delivery_sanitize_choices'
    ));
    $wp_customize->add_control( 'online_food_delivery_grid_post_blocks', array(
        'section' => 'online_food_delivery_grid_post',
        'type' => 'select',
        'label' => __( 'Post blocks', 'online-food-delivery' ),
        'choices' => array(
	...
	$wp_customize->add_setting( 'online_food_delivery_grid_post_featured_image_border_radius', array(
		'default' => 0,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_float'
	) );
	$wp_customize->add_control( 'online_food_delivery_grid_post_featured_image_border_radius', array(
		'label' => __( 'Featured image border radius','online-food-delivery' ),
		'section' => 'online_food_delivery_grid_post',
		'type'  => 'number',
		'input_attrs' => array(
	...
	$wp_customize->add_setting('online_food_delivery_scroll_icon_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'online_food_delivery_scroll_icon_hover_color', array(
		'label'    => __('Back To Top Icon Hover Color', 'online-food-delivery'),
		'section'  => 'online_food_delivery_footer_section',
	)));
	...
	$wp_customize->add_setting('online_food_delivery_scroll_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_scroll_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Back to Top Text Transform','online-food-delivery'),
		'choices' => array(
            'Uppercase' => __('Uppercase','online-food-delivery'),
            'Capitalize' => __('Capitalize','online-food-delivery'),
            'Lowercase' => __('Lowercase','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_footer_template',array(
		'default'	=> 'online_food_delivery-footer-one',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices'	
	));
	$wp_customize->add_control('online_food_delivery_footer_template',array(
		'type' => 'select',
		'label'	=> __('Footer style','online-food-delivery'),
		'section'	=> 'online_food_delivery_footer_section',
		'choices' => array(
			'online_food_delivery-footer-one' => __('Style 1', 'online-food-delivery'),
			'online_food_delivery-footer-two' => __('Style 2', 'online-food-delivery'),
			'online_food_delivery-footer-three' => __('Style 3', 'online-food-delivery'),
			'online_food_delivery-footer-four' => __('Style 4', 'online-food-delivery'),
		)
	));	
	...
	$wp_customize->add_setting('online_food_delivery_footer_img_position',array(
		'default' => 'center center',
		'transport' => 'refresh',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_footer_img_position',array(
		'type' => 'select',
		'label' => __('Footer Image Position','online-food-delivery'),
		'section' => 'online_food_delivery_footer_section',
		'choices' 	=> array(
			'left top' 		=> esc_html__( 'Top Left', 'online-food-delivery' ),
			'center top'   => esc_html__( 'Top', 'online-food-delivery' ),
			'right top'   => esc_html__( 'Top Right', 'online-food-delivery' ),
			'left center'   => esc_html__( 'Left', 'online-food-delivery' ),
			'center center'   => esc_html__( 'Center', 'online-food-delivery' ),
			'right center'   => esc_html__( 'Right', 'online-food-delivery' ),
			'left bottom'   => esc_html__( 'Bottom Left', 'online-food-delivery' ),
			'center bottom'   => esc_html__( 'Bottom', 'online-food-delivery' ),
			'right bottom'   => esc_html__( 'Bottom Right', 'online-food-delivery' ),
		),
	));

	$wp_customize->add_setting('online_food_delivery_img_footer',array(
		'default'=> 'scroll',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_img_footer',array(
		'type' => 'select',
		'label' => __('Footer Background Attatchment','online-food-delivery'),
		'choices' => array(
		'fixed' => __('fixed','online-food-delivery'),
		'scroll' => __('scroll','online-food-delivery'),
	),
		'section'=> 'online_food_delivery_footer_section',
	));
    ...
    // text trasform
	$wp_customize->add_setting('online_food_delivery_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','online-food-delivery'),
		'section'=> 'online_food_delivery_footer_section',
		'choices' => array(
      'Uppercase' => __('Uppercase','online-food-delivery'),
      'Capitalize' => __('Capitalize','online-food-delivery'),
    ...
    $wp_customize->add_setting('online_food_delivery_widgets_heading_fontsize',array(
		'default'	=> 25,
		'sanitize_callback'	=> 'online_food_delivery_sanitize_float',
	));	
	$wp_customize->add_control('online_food_delivery_widgets_heading_fontsize',array(
		'label'	=> __('Footer Widgets Heading Font Size','online-food-delivery'),
		'section'	=> 'online_food_delivery_footer_section',
		'type'		=> 'number'
	));

	$wp_customize->add_setting('online_food_delivery_widgets_heading_font_weight',array(
        'default' => '',
        'sanitize_callback' => 'online_food_delivery_sanitize_choices'
    ));
    $wp_customize->add_control('online_food_delivery_widgets_heading_font_weight',array(
        'type' => 'select',
        'label' => __('Footer Widgets Heading Font Weight','online-food-delivery'),
        'section' => 'online_food_delivery_footer_section',
        'choices' => array(
            '100' => __('100','online-food-delivery'),
            '200' => __('200','online-food-delivery'),
	...
	$wp_customize->add_setting('online_food_delivery_button_footer_heading_letter_spacing',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('online_food_delivery_button_footer_heading_letter_spacing',array(
		'label'	=> __('Footer Widgets Heading Letter Spacing','online-food-delivery'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// sticky copyright 
	$wp_customize->add_setting( 'online_food_delivery_copyright_sticky',array(
      	'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
    ) );
    $wp_customize->add_control('online_food_delivery_copyright_sticky',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Sticky Copyright','online-food-delivery' ),
        'section' => 'online_food_delivery_footer_section'
    ));
	...
	//Footer Social Icons
	$wp_customize->add_section('online_food_delivery_social_icons_section',array(
		'title'	=> __('Footer Social Icons','online-food-delivery'),
		'priority'	=> null,
		'panel' => 'online_food_delivery_panel_id',
	));
	$wp_customize->selective_refresh->add_partial(
		'online_food_delivery_facebook_url',
		array(
			'selector'        => '.social-media',
			'render_callback' => 'online_food_delivery_customize_partial_online_food_delivery_facebook_url',
		)
	);
	$wp_customize->add_setting('online_food_delivery_show_footer_social_icon',array(
        'default' => true,
        'sanitize_callback'	=> 'online_food_delivery_sanitize_checkbox'
	));
	$wp_customize->add_control('online_food_delivery_show_footer_social_icon',array(
     	'type' => 'checkbox',
      	'label' => __('Show/Hide Social Icons','online-food-delivery'),
      	'section' => 'online_food_delivery_social_icons_section',
	));
	$wp_customize->add_setting('online_food_delivery_footer_facebook_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('online_food_delivery_footer_facebook_url',array(
		'label'	=> __('Add Facebook link','online-food-delivery'),
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_facebook_url',
		'type'	=> 'url'
	));
	$wp_customize->add_setting('online_food_delivery_footer_facebook_icon',array(
		'default'	=> 'fab fa-facebook-f',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_delivery_Icon_Changer(
		$wp_customize,'online_food_delivery_footer_facebook_icon',array(
		'label'	=> __('Add Facebook Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_facebook_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('online_food_delivery_footer_twitter_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('online_food_delivery_footer_twitter_url',array(
		'label'	=> __('Add Twitter link','online-food-delivery'),
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_twitter_url',
		'type'	=> 'url'
	));
	$wp_customize->add_setting('online_food_delivery_footer_twitter_icon',array(
		'default'	=> 'fab fa-twitter',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_delivery_Icon_Changer(
		$wp_customize,'online_food_delivery_footer_twitter_icon',array(
		'label'	=> __('Add Twitter Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_twitter_icon',
		'type'		=> 'icon'
	)));
	$wp_customize->add_setting('online_food_delivery_footer_linkedin_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('online_food_delivery_footer_linkedin_url',array(
		'label'	=> __('Add Linkedin link','online-food-delivery'),
		'section' => 'online_food_delivery_social_icons_section',
		'type'	=> 'text'
	));

	$wp_customize->add_setting('online_food_delivery_footer_linkedin_icon',array(
		'default'	=> 'fab fa-linkedin-in',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_footer_linkedin_icon',array(
		'label'	=> __('Add Linkedin Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_linkedin_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('online_food_delivery_footer_instagram_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('online_food_delivery_footer_instagram_url',array(
		'label'	=> __('Add Instagram link','online-food-delivery'),
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_instagram_url',
		'type'	=> 'url'
	));
	$wp_customize->add_setting('online_food_delivery_footer_instagram_icon',array(
		'default'	=> 'fab fa-instagram',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_delivery_Icon_Changer(
		$wp_customize,'online_food_delivery_footer_instagram_icon',array(
		'label'	=> __('Add Instagram Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_instagram_icon',
		'type'		=> 'icon'
	)));
	
	$wp_customize->add_setting('online_food_delivery_footer_whatsapp_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('online_food_delivery_footer_whatsapp_url',array(
		'label'	=> __('Add WhatsApp URL','online-food-delivery'),
		'section' => 'online_food_delivery_social_icons_section',
		'type'	=> 'text'
	));

	$wp_customize->add_setting('online_food_delivery_footer_whatsapp_icon',array(
		'default'	=> 'fab fa-whatsapp',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_Delivery_Icon_Changer(
        $wp_customize,'online_food_delivery_footer_whatsapp_icon',array(
		'label'	=> __('Add Whatsapp Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_whatsapp_icon',
	...
	$wp_customize->add_setting('online_food_delivery_footer_pintrest_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('online_food_delivery_footer_pintrest_url',array(
		'label'	=> __('Add pintrest link','online-food-delivery'),
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_pintrest_url',
		'type'		=> 'url'
	));
	$wp_customize->add_setting('online_food_delivery_footer_pintrest_icon',array(
		'default'	=> 'fab fa-pinterest-p',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Online_Food_delivery_Icon_Changer(
		$wp_customize,'online_food_delivery_footer_pintrest_icon',array(
		'label'	=> __('Add pintrest Icon','online-food-delivery'),
		'transport' => 'refresh',
		'section'	=> 'online_food_delivery_social_icons_section',
		'setting'	=> 'online_food_delivery_footer_pintrest_icon',
		'type'		=> 'icon'
	)));
	$wp_customize->add_setting( 'online_food_delivery_footer_icon_font_size', array(
		'default'           => '',
		'sanitize_callback' => 'online_food_delivery_sanitize_float',
	) );
	$wp_customize->add_control( 'online_food_delivery_footer_icon_font_size', array(
		'label' => __( 'Icon Font Size','online-food-delivery' ),
		'section'     => 'online_food_delivery_social_icons_section',
		'type'        => 'number',
		'input_attrs' => array(
			'step' => 1,
	...
	$wp_customize->add_setting('online_food_delivery_footer_icon_alignment',array(
		'default' => 'Center',
		'sanitize_callback' => 'online_food_delivery_sanitize_choices'
	));
	$wp_customize->add_control('online_food_delivery_footer_icon_alignment',array(
		'type' => 'select',
		'label' => __('Icon Alignment','online-food-delivery'),
		'section' => 'online_food_delivery_social_icons_section',
		'choices' => array(
			'Left' => __('Left','online-food-delivery'),
			'Right' => __('Right','online-food-delivery'),
	...
	$wp_customize->add_setting( 'online_food_delivery_footer_icon_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'online_food_delivery_footer_icon_color', array(
		'label' => __('Icon Color', 'online-food-delivery'),
		'section' => 'online_food_delivery_social_icons_section',
		'settings' => 'online_food_delivery_footer_icon_color',
	)));
	...
	$wp_customize->add_setting('online_food_delivery_open_menu_label',array(
       'default' => __('Open Menu','online-food-delivery'),
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('online_food_delivery_open_menu_label',array(
       'type' => 'text',
       'label' => __('Open Menu Label','online-food-delivery'),
       'section' => 'online_food_delivery_mobile_media_options'
    ));
	...
	$wp_customize->add_setting('online_food_delivery_close_menu_label',array(
       'default' => __('Close Menu','online-food-delivery'),
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('online_food_delivery_close_menu_label',array(
       'type' => 'text',
       'label' => __('Close Menu Label','online-food-delivery'),
       'section' => 'online_food_delivery_mobile_media_options'
    ));
	...
	$wp_customize->add_setting('online_food_delivery_menu_toggle_btn_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'online_food_delivery_menu_toggle_btn_bg_color', array(
		'label'    => __('Toggle Button Bg Color', 'online-food-delivery'),
		'section'  => 'online_food_delivery_mobile_media_options',
	)));	

	// Responsive Slider Height (Mobile)
	$wp_customize->add_setting( 'online_food_delivery_slider_img_height_responsive', array(
	    'default'           => '',
	    'sanitize_callback' => 'online_food_delivery_sanitize_float',
	) );

	$wp_customize->add_control( 'online_food_delivery_slider_img_height_responsive', array(
	    'label'       => esc_html__( 'Slider Height (Mobile)', 'online-food-delivery' ),
	    'section'     => 'online_food_delivery_mobile_media_options',
	    'type'        => 'number',
	    'description' => esc_html__( 'Measurement is in pixels.', 'online-food-delivery' ),
	    'input_attrs' => array(
	        'step' => 1,
	        'min'  => 100,
	        'max'  => 1000,
...
final class Online_Food_Delivery_Customize {
	...
	public function sections( $manager ) {
		...
		load_template( trailingslashit( get_template_directory() ) . 'inc/online-food-customize-upsell-section.php' );
		...
		$manager->add_section(
			new Online_Food_Delivery_Customize_Section_Pro(
				...
				array(
					...
					'pro_text' => esc_html__( 'Get Pro','online-food-delivery' ),
					'pro_url'  => esc_url( 'https://www.themescaliber.com/products/food-ordering-wordpress-theme' ),
				)
			)
		);
			...
			$manager->add_section(
				new Online_Food_Delivery_Customizer_Upsell_Section(
					$manager, 'online-food-delivery-upsell-frontpage-sections', array(
						'panel'       => 'online_food_delivery_panel_id',
						'priority'    => 500,
						'options'     => array(
							esc_html__( 'Our Products Section', 'online-food-delivery' ),
							esc_html__( 'Rest Cafe Section', 'online-food-delivery' ),
							esc_html__( 'Home Delivery Section', 'online-food-delivery' ),
							esc_html__( 'Order Process Section', 'online-food-delivery' ),
							esc_html__( 'Video Section', 'online-food-delivery' ),
							esc_html__( 'Team Section', 'online-food-delivery' ),
							esc_html__( 'Reservation Section', 'online-food-delivery' ),
							esc_html__( 'Testimonial Section', 'online-food-delivery' ),
							esc_html__( 'Food Delivery Section', 'online-food-delivery' ),
							esc_html__( 'Newsletter Section', 'online-food-delivery' ),
							esc_html__( 'Blog Section', 'online-food-delivery' ),
						),
						'button_url'  => esc_url( 'https://www.themescaliber.com/products/food-ordering-wordpress-theme' ),
						'button_text' => esc_html__( 'View PRO version', 'online-food-delivery' ),
					)
				)
			);
	}
