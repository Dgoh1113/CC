...
if ( ! class_exists( 'Online_Food_Delivery_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Online_Food_Delivery_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'online_food_delivery_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function online_food_delivery_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Online_Food_Delivery_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'online_food_delivery_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function online_food_delivery_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Online_Food_Delivery_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
