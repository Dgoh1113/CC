...
window.addEventListener('scroll', function() {
  var online_food_delivery_sticky = document.querySelector('.copyright-sticky');
  if (!online_food_delivery_sticky) return;
  ...
  if (scrollTop >= 100 && !isBottom) {
    online_food_delivery_sticky.classList.add('copyright-fixed');
  } else {
    online_food_delivery_sticky.classList.remove('copyright-fixed');
  }
});
