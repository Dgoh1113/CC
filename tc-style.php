<?php 
	...
	if ($online_food_delivery_first_theme_color) {
		$online_food_delivery_custom_css .= ':root {';
		$online_food_delivery_custom_css .= '--primary-color: ' . esc_attr($online_food_delivery_first_theme_color) . ' !important;';
		$online_food_delivery_custom_css .= '} ';
	}

	if ($online_food_delivery_second_theme_color) {
		$online_food_delivery_custom_css .= ':root {';
		$online_food_delivery_custom_css .= '--secondary-color: ' . esc_attr($online_food_delivery_second_theme_color) . ' !important;';
		$online_food_delivery_custom_css .= '} ';
	}

	
	// sticky sidebar
	$online_food_delivery_sticky_sidebar = get_theme_mod('online_food_delivery_sticky_sidebar');
	if ( $online_food_delivery_sticky_sidebar ) {
		$online_food_delivery_custom_css .= '@media (min-width: 768px) {';
			$online_food_delivery_custom_css .= '#sidebar {';
				$online_food_delivery_custom_css .= 'position: sticky;';
				$online_food_delivery_custom_css .= 'top: 50px; margin-bottom: 30px;';
			$online_food_delivery_custom_css .= '}';
		$online_food_delivery_custom_css .= '}';
	}
	...
	//Button Shape
	$online_food_delivery_btn_shape = get_theme_mod('online_food_delivery_btn_shape', 'Square');
	if($online_food_delivery_btn_shape == 'Square' ){
		$online_food_delivery_custom_css .='.read-btn a.blogbutton-small, #comments input[type="submit"].submit, .hvr-sweep-to-right:before{';
			$online_food_delivery_custom_css .=' border-radius: 0';
		$online_food_delivery_custom_css .='}';
	}elseif($online_food_delivery_btn_shape == 'Round' ){
		$online_food_delivery_custom_css .='.read-btn a.blogbutton-small, #comments input[type="submit"].submit, .hvr-sweep-to-right:before{';
			$online_food_delivery_custom_css .=' border-radius: .3em';
		$online_food_delivery_custom_css .='}';
	}elseif($online_food_delivery_btn_shape == 'Pill' ){
		$online_food_delivery_custom_css .='.read-btn a.blogbutton-small, #comments input[type="submit"].submit, .hvr-sweep-to-right:before{';
			$online_food_delivery_custom_css .=' border-radius: 2em;';
		$online_food_delivery_custom_css .='}';
	}

	//Button hover effect
	$online_food_delivery_button_hover_effect = get_theme_mod('online_food_delivery_button_hover_effect', 'disable');
	if ($online_food_delivery_button_hover_effect !== 'disable') {
		$online_food_delivery_custom_css .= '.read-btn a.blogbutton-small:hover {';
		switch ($online_food_delivery_button_hover_effect) {
			case 'pulse':
				$online_food_delivery_custom_css .= 'animation: pulse 0.5s ease-in-out;';
				break;
			case 'rubberBand':
				$online_food_delivery_custom_css .= 'animation: rubberBand 0.5s ease-in-out;';
				break;
			case 'swing':
				$online_food_delivery_custom_css .= 'animation: swing 0.5s ease-in-out;';
				break;
			case 'tada':
				$online_food_delivery_custom_css .= 'animation: tada 0.5s ease-in-out;';
				break;
			case 'jello':
				$online_food_delivery_custom_css .= 'animation: jello 0.5s ease-in-out;';
				break;
		}
		$online_food_delivery_custom_css .= '}';
	}
	...
	$online_food_delivery_preloader_background_img = get_theme_mod('online_food_delivery_preloader_background_img');
	...
	if ( $online_food_delivery_preloader_background_img != false ) {
		$online_food_delivery_custom_css .= '.preloader{';
		$online_food_delivery_custom_css .= 'background: url(' . esc_url( $online_food_delivery_preloader_background_img ) . ');';
		$online_food_delivery_custom_css .= '-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;';
		$online_food_delivery_custom_css .= '}';
	}
	...
	$online_food_delivery_scroll_text_transform = get_theme_mod( 'online_food_delivery_scroll_text_transform','Capitalize');
	if($online_food_delivery_scroll_text_transform== 'Capitalize'){
		$online_food_delivery_custom_css .='.scrollup{';
			$online_food_delivery_custom_css .='text-transform:Capitalize;';
		$online_food_delivery_custom_css .='}';
	}
	if($online_food_delivery_scroll_text_transform == 'Lowercase'){
		$online_food_delivery_custom_css .='.scrollup{';
			$online_food_delivery_custom_css .='text-transform:Lowercase;';
		$online_food_delivery_custom_css .='}';
	}
	if($online_food_delivery_scroll_text_transform == 'Uppercase'){
		$online_food_delivery_custom_css .='.scrollup{';
	...
	$online_food_delivery_menu_toggle_btn_bg_color = get_theme_mod('online_food_delivery_menu_toggle_btn_bg_color');
	if($online_food_delivery_menu_toggle_btn_bg_color != false){
		$online_food_delivery_custom_css .='.toggle-menu i {';
			$online_food_delivery_custom_css .='background: '.esc_attr($online_food_delivery_menu_toggle_btn_bg_color).'';
		$online_food_delivery_custom_css .='}';
	}	
	...
	// sticky copyright
	$online_food_delivery_resp_stickycopyright = get_theme_mod( 'online_food_delivery_stickycopyright_hide_show',false);
	if($online_food_delivery_resp_stickycopyright == true && get_theme_mod( 'online_food_delivery_copyright_sticky',false) != true){
    	$online_food_delivery_custom_css .='.copyright-sticky{';
			$online_food_delivery_custom_css .='position:static;';
		$online_food_delivery_custom_css .='} ';
	}
	...
	$online_food_delivery_theme_lay = get_theme_mod( 'online_food_delivery_footer_template','online_food_delivery-footer-one');
	if($online_food_delivery_theme_lay == 'online_food_delivery-footer-one'){
		$online_food_delivery_custom_css .='.footertown{';
			$online_food_delivery_custom_css .='';
		$online_food_delivery_custom_css .='}';

	}else if($online_food_delivery_theme_lay == 'online_food_delivery-footer-two'){
		$online_food_delivery_custom_css .='.footertown {';
			$online_food_delivery_custom_css .='background-color: #F2E6D9 !important;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown p,.footertown span,.footertown li a,.footertown #wp-calendar caption,.footertown #wp-calendar td,.footertown #wp-calendar th, .footertown, .footertown h3, .footertown a.rsswidget, .footertown #wp-calendar a, .copyright a, .footertown .custom_details, .footertown ins span, .footertown .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, .footertown ul li a, .footertown table, .footertown th, .footertown td, .footertown caption, #sidebar caption,.footertown nav.wp-calendar-nav a,.footertown .search-form .search-field, .footertown .widget ul li, .footertown .rssSummary, .footertown cite, .footertown strong {';
			$online_food_delivery_custom_css .='color:#000 !important;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown p{';
			$online_food_delivery_custom_css .='color:#000 !important;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown ul li::before{';
			$online_food_delivery_custom_css .='background-color:#000;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown table, .footertown th, .footertown td,.footertown.search-form .search-field,.footertown .tagcloud a{';
			$online_food_delivery_custom_css .='border: 1px solid #000;';
		$online_food_delivery_custom_css .='}';

	}else if($online_food_delivery_theme_lay == 'online_food_delivery-footer-three'){
		$online_food_delivery_custom_css .='.footertown {';
			$online_food_delivery_custom_css .='background-color: #37474F !important;;';
		$online_food_delivery_custom_css .='}';
	}
	else if($online_food_delivery_theme_lay == 'online_food_delivery-footer-four'){
		$online_food_delivery_custom_css .='.footertown {';
			$online_food_delivery_custom_css .='background-color: #102A43 !important;;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown p,.footertown span,.footertown li a,.footertown #wp-calendar caption,.footertown #wp-calendar td,.footertown #wp-calendar th, .footertown, .footertown h3, .footertown a.rsswidget, .footertown #wp-calendar a, .copyright a, .footertown .custom_details, .footertown ins span, .footertown .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, .footertown ul li a, .footertown table, .footertown th, .footertown td, .footertown caption, #sidebar caption,.footertown nav.wp-calendar-nav a,.footertown .search-form .search-field, , .footertown .widget ul li, .footertown .rssSummary, .footertown cite, .footertown strong{';
			$online_food_delivery_custom_css .='color:#000 !important;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown p{';
			$online_food_delivery_custom_css .='color:#fff !important;';
		$online_food_delivery_custom_css .='}';
		$online_food_delivery_custom_css .='.footertown ul li::before{';
			$online_food_delivery_custom_css .='background-color:#000;';
		$online_food_delivery_custom_css .='}';
	...
	if($online_food_delivery_featured_image_border_radius != false){
		$online_food_delivery_custom_css .='.inner-service .post-box img{';
	...
	$online_food_delivery_blog_post_featured_image_dimension = get_theme_mod('online_food_delivery_blog_post_featured_image_dimension', 'default');
	$online_food_delivery_blog_post_featured_image_custom_width = get_theme_mod('online_food_delivery_blog_post_featured_image_custom_width',250);
	$online_food_delivery_blog_post_featured_image_custom_height = get_theme_mod('online_food_delivery_blog_post_featured_image_custom_height',250);
	if($online_food_delivery_blog_post_featured_image_dimension == 'custom'){
		$online_food_delivery_custom_css .='.post .services-box .blog-image img{';
			$online_food_delivery_custom_css .='width: '.esc_attr($online_food_delivery_blog_post_featured_image_custom_width).'!important; height: '.esc_attr($online_food_delivery_blog_post_featured_image_custom_height).';';
		$online_food_delivery_custom_css .='}';
	}
	...
	if($online_food_delivery_post_blocks == 'Within box' ){
		$online_food_delivery_custom_css .='.post-box{';
...
if($online_food_delivery_slider_layout == '0'){
	...
	// menu padding
	$online_food_delivery_menu_padding = get_theme_mod('online_food_delivery_menu_padding');
	$online_food_delivery_custom_css .='.primary-navigation ul li a{';
		$online_food_delivery_custom_css .='padding: '.esc_attr($online_food_delivery_menu_padding).'px;';
	$online_food_delivery_custom_css .='}';

	// Menu Item Hover Style	
	$online_food_delivery_menus_item = get_theme_mod( 'online_food_delivery_menus_item_style','None');
	if($online_food_delivery_menus_item == 'None'){
		$online_food_delivery_custom_css .='.primary-navigation ul li a{';
			$online_food_delivery_custom_css .='';
		$online_food_delivery_custom_css .='}';
	}else if($online_food_delivery_menus_item == 'Zoom In'){
		$online_food_delivery_custom_css .='.primary-navigation ul li a:hover{';
			$online_food_delivery_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important;';
		$online_food_delivery_custom_css .='}';
	}
	...
	$online_food_delivery_single_post_featured_image_dimension = get_theme_mod('online_food_delivery_single_post_featured_image_dimension', 'default');
	$online_food_delivery_single_post_featured_image_custom_width = get_theme_mod('online_food_delivery_single_post_featured_image_custom_width');
	$online_food_delivery_single_post_featured_image_custom_height = get_theme_mod('online_food_delivery_single_post_featured_image_custom_height');
	if($online_food_delivery_single_post_featured_image_dimension == 'custom'){
		$online_food_delivery_custom_css .='.feature-box.single-post-img img{';
			$online_food_delivery_custom_css .='width: '.esc_attr($online_food_delivery_single_post_featured_image_custom_width).'!important; height: '.esc_attr($online_food_delivery_single_post_featured_image_custom_height).';';
		$online_food_delivery_custom_css .='}';
	}
	...
	// Slider Height
	$online_food_delivery_slider_img_height      = get_theme_mod('online_food_delivery_slider_height');
	$online_food_delivery_slider_img_height_resp = get_theme_mod('online_food_delivery_slider_img_height_responsive');

	// Desktop height
	$online_food_delivery_custom_css .= '@media screen and (min-width: 768px) {';
	$online_food_delivery_custom_css .= '#slider img {';
	if ( $online_food_delivery_slider_img_height ) {
	    $online_food_delivery_custom_css .= 'height: ' . esc_attr( $online_food_delivery_slider_img_height ) . 'px !important;';
	}
	$online_food_delivery_custom_css .= 'width: 100%;';
	$online_food_delivery_custom_css .= '}';
	$online_food_delivery_custom_css .= '}';

	// Mobile height
	$online_food_delivery_custom_css .= '@media screen and (max-width: 767px) {';
	$online_food_delivery_custom_css .= '#slider img {';
	if ( $online_food_delivery_slider_img_height_resp ) {
	    $online_food_delivery_custom_css .= 'height: ' . esc_attr( $online_food_delivery_slider_img_height_resp ) . 'px !important;';
	}
	$online_food_delivery_custom_css .= 'width: 100%;';
	$online_food_delivery_custom_css .= '}';
	$online_food_delivery_custom_css .= '}';
	...
	$online_food_delivery_grid_post_metabox_seperator = get_theme_mod('online_food_delivery_grid_post_metabox_seperator','|');
	if($online_food_delivery_grid_post_metabox_seperator != '' ){
		$online_food_delivery_custom_css .='.grid-post-box .metabox .me-2:after{';
			$online_food_delivery_custom_css .=' content: "'.esc_attr($online_food_delivery_grid_post_metabox_seperator).'"; padding-left:10px;';
		$online_food_delivery_custom_css .='}';		
	}

	// Grid Post into blocks
	$online_food_delivery_grid_post_blocks = get_theme_mod('online_food_delivery_grid_post_blocks', 'Without box');
	if($online_food_delivery_grid_post_blocks == 'Within box' ){
		$online_food_delivery_custom_css .='.services-box .grid-post-box{';
			$online_food_delivery_custom_css .=' border: 1px solid #222;';
		$online_food_delivery_custom_css .='}';
	}

	// Grid Post Featured image css
	$online_food_delivery_grid_post_featured_image_border_radius = get_theme_mod('online_food_delivery_grid_post_featured_image_border_radius');
	if($online_food_delivery_grid_post_featured_image_border_radius != false){
		$online_food_delivery_custom_css .='.inner-service .grid-post-box img{';
			$online_food_delivery_custom_css .='border-radius: '.esc_attr($online_food_delivery_grid_post_featured_image_border_radius).'px;';
		$online_food_delivery_custom_css .='}';
	}
	...
	$online_food_delivery_related_post_metabox_seperator = get_theme_mod('online_food_delivery_related_post_metabox_seperator','|');
	if($online_food_delivery_related_post_metabox_seperator != '' ){
		$online_food_delivery_custom_css .='.related-posts .metabox .entry-date:after,.related-posts .metabox .entry-author:after,.related-posts .metabox .entry-comments:after{';
			$online_food_delivery_custom_css .=' content: "'.esc_attr($online_food_delivery_related_post_metabox_seperator).'"; padding-left:1px;';
			$online_food_delivery_custom_css .= 'display: inline; ';
		$online_food_delivery_custom_css .='}';		
	}
	...
	$online_food_delivery_button_footer_heading_letter_spacing = get_theme_mod('online_food_delivery_button_footer_heading_letter_spacing');
	$online_food_delivery_custom_css .='.footertown .widget h3,a.rsswidget.rss-widget-title{';
		$online_food_delivery_custom_css .='letter-spacing: '.esc_attr($online_food_delivery_button_footer_heading_letter_spacing).'px;';
	$online_food_delivery_custom_css .='}';
    ...
    if($online_food_delivery_footer_widgets_content == 'Left'){
		$online_food_delivery_custom_css .='footer .footer-block p,footer ul,.widget_shopping_cart_content p,footer form,div#calendar_wrap,.footertown table,footer.gallery,aside#media_image-2,.tagcloud,footer figure.gallery-item,aside#block-7,.textwidget p,#calendar-2 caption{';
		$online_food_delivery_custom_css .='text-align: left;';
		$online_food_delivery_custom_css .='}';
	...
	//Initial Cap
	$online_food_delivery_initial_caps_enable = get_theme_mod('online_food_delivery_initial_caps_enable', 'false');
	if($online_food_delivery_initial_caps_enable == 'true' ){
		$online_food_delivery_custom_css .='.post-box p:nth-of-type(1)::first-letter{';
			$online_food_delivery_custom_css .=' font-size: 60px!important; font-weight: 800!important;';
		$online_food_delivery_custom_css .=' margin-right: 10px!important;';
			$online_food_delivery_custom_css .=' font-family: "Vollkorn", serif!important;';
			$online_food_delivery_custom_css .=' line-height: 1!important;';
		$online_food_delivery_custom_css .='}';
	}elseif($online_food_delivery_initial_caps_enable == 'false' ){
		$online_food_delivery_custom_css .='.post-box p:nth-of-type(1)::first-letter{';
			$online_food_delivery_custom_css .='display: none!important;';
		$online_food_delivery_custom_css .='}';
	}
